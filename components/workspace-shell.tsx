...
const primary = [["Overview", "/dashboard"], ["VA Guide", "/guide"], ["Skills", "/skills"], ["Tasks", "/tasks"], ["Workflows", "/workflows"], ["Practice", "/tasks"], ["Templates", "/templates"], ["SOPs", "/sops"], ["AI Guide", "/ai-guide"], ["Portfolio", "/portfolio"]] as const;
  ...
  return <>
    <div className="workspace-shell">
      <aside className="workspace-sidebar">
        ...
        <nav className="workspace-nav">{primary.map(([label, href]) => <Link key={href + label} href={href} className={active(href) ? "active" : ""}>{label}</Link>)}</nav>
